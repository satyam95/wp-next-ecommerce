            ...
            <div className="flex flex-col-reverse sm:flex-row gap-4 w-full">
              <div className="sm:min-w-32 flex sm:flex-col gap-2 overflow-x-auto sm:overflow-hidden justify-between">
                {[...Array(4)].map((_, index) => (
                  <div
                    key={index}
                    className="aspect-square h-20 w-20 sm:w-32 sm:h-32 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse w-1/4"
                  />
                ))}
              </div>
              <div className="aspect-square bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse w-full" />
            </div>
          </div>
